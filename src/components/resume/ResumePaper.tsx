...
export const DEFAULT_RESUME_DATA: ResumeData = {
  fullName: "YASH",
  professionalTitle: "Data Driven Digital Marketer",
  location: "Delhi",
  email: "kumaryashappy@gmail.com",
  phone: "+91 84484 11672",
  linkedin: "Linkedin.com/in/yashappy",
  portfolio: "https://linkedin.com/in/yashappy",
  professionalSummary:
    "AI-powered and data-driven Digital Marketing Strategist with over 3 years of experience in social media strategy, brand management, brand identity design, content creation, SEO, and market research. Skilled in crafting cohesive brand strategies, analyzing trends, and leading cross-functional teams to drive growth, engagement, and measurable business impact.",
  experiences: [
    {
      company: "Startup Age",
      role: "Social Media Growth Lead",
      title: "Startup Age | Social Media Growth Lead",
      duration: "Nov. 2025 - Currently",
      bullets: [
        "Scaled Startup Age from 0 → 24M+ Instagram views, reaching 12M+ users and 498K+ interactions and gained 4k organic followers.",
        "Produced high-performing content; grew YouTube to 6.8M+ views and drove 1.2M+ LinkedIn impressions in 90 days.",
        "Led a 7-member team across content, design, publishing, and community engagement",
        "Managed communities, driving engagement via comments, DMs, and discussions; tracked sentiment, advocates, and key metrics.",
      ],
    },
    {
      company: "Kaarigar",
      role: "Marketing Manager",
      title: "Marketing Manager | Kaarigar",
      duration: "Feb. 2025 - Nov. 2025",
      bullets: [
        "Achieved 15× organic growth across Instagram, Facebook, and YouTube",
        "Drove 1.3M+ Facebook views, 515K+ Instagram reach, and 185K+ Pinterest views via content strategy",
        "Increased store footfall via Meta campaigns; managed influencers, collaborations, and community via DMs and comments",
        "Built SEO-optimized WordPress site ranking on Google’s first page; led teams contributing to 70% revenue growth",
      ],
    },
    {
      company: "Golden BRX",
      role: "Digital Marketing Manager",
      title: "Digital Marketing Manager | Golden BRX",
      duration: "Jan. 2024 - Jan. 2025",
      bullets: [
        "Boosted social impressions by 1,300% and engagement by 540% through targeted, performance-driven content.",
        "Led Meta Ads for real estate, reducing CPL by 40% and improving ROI and retention.",
        "Designed brand identity and led a content team to streamline creative execution.",
      ],
    },
    {
      company: "Won Buddhist Charitable Society",
      role: "Content Creation Executive",
      title: "Content Creation Executive | Won Buddhist Charitable Society",
      duration: "Apr. 2023 - Dec. 2023",
      bullets: [
        "Shot and edited content highlighting educational initiatives in remote Leh regions.",
        "Created impactful content showcasing the NGO’s mission and impact.",
      ],
    },
  ],
  education: [
    ...
    {
      degree: "Bachelors in Digital Media & Design",
      score: "77%",
      institution: "Delhi",
      year: "2024",
    },
